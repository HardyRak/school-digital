...
import com.hard.cegAndranovelona.repository.AbsenceRepository;
...
public class AbsenceService {
    ...
    public Absence saveOrUpdate(Absence entity) {
    ...
    public Page<Absence> getAll(int page, int size, String fieldTri) {
        Sort sort = null;
    ...
    public List<Absence> getAbsenceByEtudiant(Etudiants etudiants){
